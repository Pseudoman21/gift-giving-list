        ...
        <div className="mb-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={addPerson}
                className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 whitespace-nowrap"
              >
                    ...
                    <>
                      ...
                      <div className="space-y-4">
                        ...
                        <div
                          ...
                          className={`p-4 rounded-xl cursor-pointer transition-all duration-300 transform hover:scale-[1.01] active:scale-[0.99] ${
                            person.giveMoney
                          ...
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-3">
                              <div className={`w-12 h-12 rounded-full flex items-center justify-center text-2xl ${
                                person.giveMoney ? 'bg-green-100' : 'bg-gray-100'
                              }`}>
                                💵
                              </div>
                              <div>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              <div className={`w-12 h-12 rounded-full flex items-center justify-center text-2xl ${
                                person.giveGift ? 'bg-red-100' : 'bg-gray-100'
                              }`}>
                                🎁
                              </div>
                              <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mt-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-4 border border-emerald-200">
                <div className="text-2xl font-bold text-emerald-700">₱{totalMoneyAmount.toFixed(2)}</div>
